<div class="dropdown">
    ...
    <ul>
        ...
        <?php if ($this->user->hasProjectAccess('TaskCreationController', 'show', $project['id']) && $this->projectRole->getProjectUserRole($project['id']) !== \Kanboard\Core\Security\Role::PROJECT_VIEWER): ?>
            <li>
                <?= $this->modal->large('plus', t('Add a new task '), 'TaskCreationController', 'show', array('project_id' => $project['id'])) ?>
            </li>
        <?php else: ?>
            <li>
                <?= $this->modal->large('share-square-o', t('Delegate a task to this project'), 'TaskCreationController', 'show', array('project_id' => $project['id'])) ?>
            </li>
        <?php endif ?>
